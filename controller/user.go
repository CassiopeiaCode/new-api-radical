...
func setupLogin(user *model.User, c *gin.Context) {
	...
	if origin := c.GetString("oauth_return_origin"); origin != "" {
		c.Redirect(http.StatusFound, origin+"/oauth/linuxdo")
		return
	}
	c.JSON(http.StatusOK, gin.H{
		"message": "",
...
func GetSelf(c *gin.Context) {
	...
	responseData := map[string]interface{}{
		...
		"leak_protection_balanced_forced": common.LeakProtectionBalancedForceEnabled,
...
func UpdateUserSetting(c *gin.Context) {
	...
	settings := dto.UserSetting{
		...
		DisableLeakProtectionBalanced:    req.DisableLeakProtectionBalanced && !common.LeakProtectionBalancedForceEnabled,
	}
